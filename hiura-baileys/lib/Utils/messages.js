...
const _hiura_1 = require("./hiura-crypto-utils");
const _hiura_2 = require("./hiura-crypto-utils");
const _hiura_ = require("./hiura-crypto-utils");
const _hiura_3 = require("./hiura-crypto-utils");
const __hiura_ = require("./hiura-crypto-utils");
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('mentions' in message && ((_a = message.mentions) === null || _a === void 0 ? void 0 : _a.length)) {
        ...
        // Normalize semua mention JID: LID → s.whatsapp.net, nomor saja → s.whatsapp.net
        const WABinary_norm = require('../WABinary');
        m[messageType].contextInfo.mentionedJid = message.mentions
            .map(j => WABinary_norm.normalizeMentionJid ? WABinary_norm.normalizeMentionJid(j) : j)
            .filter(Boolean);
    }
    if ('edit' in message) {
        m = {
